...
def input_fn(request_body, content_type=JPEG_CONTENT_TYPE):
    ...
    if content_type == JSON_CONTENT_TYPE:
        ...
        url = request['url']
        # Solicitud GET a la URL donde está alojada la imagen
        img_content = requests.get(url).content
        # Convierte los datos binarios de la imagen en un objeto de imagen
...
def predict_fn(input_object, model):
    ...
    with torch.no_grad():
        ...
        # Añade una dimensión batch al inicio del tensor porque el modelo de PyTorch espera un batch de imágenes
